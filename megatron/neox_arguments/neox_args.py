...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    seq_length_val: int = None
    """
    Maximum sequence length to process for val.
    """
    ...
    pos_emb: Literal[
        "learned", "rotary", "sinusoidal", "rpe", "alibi", "none", "kerple_power_ap_", "kerple_power__ap", "kerple_power_ap_ap", "kerple_power_original", "kerple_log"
    ] = "learned"
    """
